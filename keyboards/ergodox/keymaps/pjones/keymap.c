...
[LAYER_SYMB] = KEYMAP(
  ...
  KC_TRANSPARENT, KC_BSLASH,       KC_GRAVE,       KC_PIPE,        KC_PLUS,        KC_EQUAL,         KC_TRANSPARENT,
...
[LAYER_NUMBERS] = KEYMAP(
  ...
  KC_TRANSPARENT, KC_TRANSPARENT, KC_MINUS,       KC_COMMA,       KC_DOT,         KC_SLASH,       KC_TRANSPARENT,
                                  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
